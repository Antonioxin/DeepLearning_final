...
\newcommand{\expTitle}{深度学习期末报告}             % 封面正中大字
...
\newcommand{\studentName}{徐熠潘 胡鑫园 夏君旸}
\newcommand{\studentID}{24051133}
...
\begin{titlepage}
  ...
  \newcommand{\titleinfobox}[1]{%
    \parbox[c]{7.8cm}{\centering\normalsize #1\\[-0.15em]\rule{7.8cm}{0.4pt}}}

  \renewcommand{\arraystretch}{1.75}
  \begin{tabular}{>{\large\bfseries}p{2.6cm} l}
    题\quad 目 & \titleinfobox{\expFullTitle} \\
